...
class MultiPolygonTest extends BaseTestCase
{
    ...
    public function testInvalidGeoJsonException()
    {
        $this->assertException(
            \DigitalDevLX\LaravelMySqlSpatial\Exceptions\InvalidGeoJsonException::class,
    ...
    public function testInvalidArgumentExceptionAtLeastOneEntry()
    {
        $this->assertException(
            ...
            'DigitalDevLX\LaravelMysqlSpatial\Types\MultiPolygon must contain at least 1 entry'
        );
    ...
    public function testInvalidArgumentExceptionNotArrayOfPolygon()
    {
        $this->assertException(
            InvalidArgumentException::class,
            'DigitalDevLX\LaravelMysqlSpatial\Types\MultiPolygon must be a collection of DigitalDevLX\LaravelMysqlSpatial\Types\Polygon'
        );
        $multipolygon = new MultiPolygon([
            $this->getPolygon1(),
            $this->getLineString1(),
