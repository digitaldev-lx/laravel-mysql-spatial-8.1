...
use DigitalDevLX\LaravelMySqlSpatial\Types\GeometryCollection;
use DigitalDevLX\LaravelMySqlSpatial\Types\LineString;
use DigitalDevLX\LaravelMySqlSpatial\Types\MultiPoint;
use DigitalDevLX\LaravelMySqlSpatial\Types\MultiPolygon;
...
class SpatialTest extends IntegrationBaseTestCase
{
    ...
    public function testSpatialFieldsNotDefinedException()
    {
        ...
        $this->assertException(\DigitalDevLX\LaravelMySqlSpatial\Exceptions\SpatialFieldsNotDefinedException::class);
    ...
    public function testOrderBySpatialWithUnknownFunction()
    {
        ...
        $this->assertException(\DigitalDevLX\LaravelMySqlSpatial\Exceptions\UnknownSpatialFunctionException::class);
    ...
    //    $point = new Point(0, 0);
    //
    //    $linestring1 = \DigitalDevLX\LaravelMysqlSpatial\Types\LineString::fromWkt("LINESTRING(1 1, 2 2)");
    //    $linestring2 = \DigitalDevLX\LaravelMysqlSpatial\Types\LineString::fromWkt("LINESTRING(20 20, 24 24)");
    //    $linestring3 = \DigitalDevLX\LaravelMysqlSpatial\Types\LineString::fromWkt("LINESTRING(0 10, 10 10)");
    //
